  ...
  <v-layout row wrap>
    <v-flex xs4>
      <v-card>
        ...
        <v-card-actions>
          <v-btn flat text color="purple">Rate this movie</v-btn>
          <v-spacer></v-spacer>
        </v-card-actions>
      </v-card>
    </v-flex>
      ...
      <v-card>
        <v-card-title primary-title>
          <div>
            ...
            <span class="grey--text">
              2017 ‧ Drama/Science fiction film ‧ 2h21m
            </span>
          </div>
        </v-card-title>
        <v-card-text>
          ...
          border. His plan to hide from the outside world gets upended when he
          meets a young mutant (Dafne Keen) who is very much like him. Logan
          must now protect the girl and battle the dark forces that want to
          capture her.
        </v-card-text>
        <v-card-actions>
          <v-btn flat text color="purple">Rate this movie</v-btn>
    ...
    <v-flex xs4>
      <v-card>
        ...
        <v-card-text>
          ...
          whotells her about the massive conflict that's raging in the outside
    ...
    <v-flex xs4>
      <v-card>
        ...
        <v-card-text>
          ...
          kills his young son (Forrest Goodluck) and leaves him for dead, Glass
          must utilize his survival skills to find a way back to civilization.
          Grief-stricken and fueled by vengeance, the legendary fur trapper
          treks through the snowy terrain to track down the man who betrayed
          him.
        </v-card-text>
        <v-card-actions>
          <v-btn flat text color="purple">Rate this movie</v-btn>
